...
module.exports.getDiscussion = function(id) {
	return {
		id : id,
...
/*****************************************************************************
*** Using dummy data until persistence layer (or something) is implemented ***
*****************************************************************************/

var dummyMessages = [
	{
		timestamp: '2015-05-25T22:00:30',
		author: {
			id: '@PeterQwarnstrom',
